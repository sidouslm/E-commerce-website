...
const login = () => {
  ...
  return (
    <form onSubmit={onSubmitHnadler} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-slate-800'>
        <div className='inline-flex items-center gap-2 mb-2 mt-10'>
            <p className=' text-3xl' style={{fontFamily: 'Bespoke Slab'}}>{currentState}</p>
        ...
        <button type="submit" className='bg-slate-900 text-slate-50 font-light px-8 py-2 mt-4 cursor-pointer'>{currentState === 'Login' ? 'Sign In' : 'Sign Up'}</button>
    </form>
  )
}
